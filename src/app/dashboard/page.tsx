...
export default function MusicApp() {
  ...
  async function refreshStreams() {
    ...
    setQueue((prevState) => [...streamsJson.streams]);
  }
  ...
  const playNext = () => {
    ...
    // Set the highest voted song as now playing
    setNowPlaying(sortedQueue[0]);
              ...
              <div className="flex flex-col items-center gap-6 md:flex-row">
                <Avatar className="h-24 w-24 rounded-md">
                  ...
                  <AvatarFallback className="rounded-md bg-purple-900">
                    {nowPlaying.title.substring(0, 2)}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold">{nowPlaying.title}</h3>
                  <p className="text-neutral-300">{nowPlaying.artist}</p>
                  <div className="mt-2 flex justify-center gap-2 md:justify-start">
                    ...
                    <Button
                      size="sm"
                      className="h-12 w-12 rounded-full bg-white p-0 text-black hover:bg-gray-200"
                    >
                      <svg
                        className="h-6 w-6"
                        viewBox="0 0 24 24"
                    ...
                    >
                      ...
                      >
                        <path
                          d="M8.5 19H13L8 12L13 5H8.5L3.5 12L8.5 19Z"
                          fill="currentColor"
                        />
                        <path
                          d="M15.5 19H20L15 12L20 5H15.5L10.5 12L15.5 19Z"
                          fill="currentColor"
                        />
                      </svg>
                    </Button>
                ...
                <div className="hidden md:block">
                  <div className="h-12 w-64 rounded-full bg-neutral-800">
                    <div className="h-full w-1/3 rounded-full bg-gradient-to-r from-purple-600 to-purple-800"></div>
                  </div>
